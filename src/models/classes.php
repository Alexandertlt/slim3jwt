...
ORDER BY `weekly_slots`.`time`";
    ...
    $sql_in = "SELECT `seasons`.`id_client`, `seasons`.`id_seas`, `clients`.`name` AS `name`, `season_types`.`name` AS `ticket_name`, `season_types`.`short_name` AS `ticket_short_name`, `seasons`.`booking`, 
